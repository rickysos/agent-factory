    ...
    <div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-blue-50 dark:bg-blue-950/40 rounded-xl p-4">
          <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Total Agents</p>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-950/40 rounded-xl p-4">
          <p className="text-sm text-yellow-600 dark:text-yellow-400 font-medium">In Draft</p>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{stats.draft}</p>
        </div>
        <div className="bg-purple-50 dark:bg-purple-950/40 rounded-xl p-4">
          <p className="text-sm text-purple-600 dark:text-purple-400 font-medium">Deployments</p>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{stats.deployments}</p>
        </div>
      </div>

      <div className="mb-6 flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Your Agents</h3>
